...
def train_one_epoch(model: torch.nn.Module, data_loader: Iterable, optimizer: torch.optim.Optimizer,
                    ...
                    normlize_target: bool = True, mean:float = 0,var:float = 0,min_value:float = 0,max_value:float = 0,log_writer=None, lr_scheduler=None, start_steps=None,
	...
	# 百分比裁剪
        ...
        surfaces = torch.cat((surfaces_l, surfaces_r), dim=2)
        labels = surfaces.to(torch.float32)
        #sigmoid
        ...
        #with torch.no_grad():
            ...
            #labels = surfaces_r.to(torch.float32)
        #loss_func = OHMELoss()
