...
def get_args():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/media/test/Cui/NSD/data_01_GLM', type=str,
                        help='dataset path')
    parser.add_argument('--imagenet_default_mean_and_std', default=True, action='store_true')

    parser.add_argument('--output_dir', default='./results/3.12_newconv',
...
def main(args):
    ...
    #GLM-halfhalf
    #mean = 0.20936724870380657
    #var = 1.8172107286305987
    #var = np.sqrt(var)
    #max_value = 108.97583770751953
    #min_value = -109.41284942626953
